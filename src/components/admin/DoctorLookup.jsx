...
//                 <div style={{ fontSize: '28px', fontWeight: 'bold', color: primaryColor }}>{selectedDoctor.totalAppointments}</div>
...
//                 <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#856404' }}>{selectedDoctor.cancelledAppointments}</div>
//                 <div style={{ fontSize: '14px', color: '#666' }}>Cancelled</div>
//               </div>
//               <div style={{ textAlign: 'center', padding: '20px', backgroundColor: '#f8d7da', borderRadius: '8px' }}>
//                 <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#721c24' }}>{selectedDoctor.noShowAppointments}</div>
//                 <div style={{ fontSize: '14px', color: '#666' }}>No Shows</div>
//               </div>
//               <div style={{ textAlign: 'center', padding: '20px', backgroundColor: '#e2f0fb', borderRadius: '8px' }}>
//                 <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#0d6efd' }}>{selectedDoctor.avgConsultationDuration}</div>
//                 <div style={{ fontSize: '14px', color: '#666' }}>Avg. Duration</div>
//               </div>
//               <div style={{ textAlign: 'center', padding: '20px', backgroundColor: '#d4edda', borderRadius: '8px' }}>
//                 <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#155724' }}>{selectedDoctor.satisfactionRating}/5</div>
//                 <div style={{ fontSize: '14px', color: '#666' }}>Satisfaction Rating</div>
//               </div>
//               {metrics && (
//                 <>
//                   <div style={{ textAlign: 'center', padding: '20px', backgroundColor: '#e2e3e5', borderRadius: '8px' }}>
//                     <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#383d41' }}>{metrics.completionRate}%</div>
//                     <div style={{ fontSize: '14px', color: '#666' }}>Completion Rate</div>
//                   </div>
//                   <div style={{ textAlign: 'center', padding: '20px', backgroundColor: '#d1ecf1', borderRadius: '8px' }}>
//                     <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#0c5460' }}>₹{(metrics.revenue / 100000).toFixed(1)}L</div>
//                     <div style={{ fontSize: '14px', color: '#666' }}>Estimated Revenue</div>
//                   </div>
//                 </>
//               )}
//             </div>
...
//                     <tr key={prescription.id} style={{ backgroundColor: index % 2 === 0 ? '#f8f9fa' : 'white' }}>
...
//                     <li key={index} style={{ marginBottom: '8px', fontSize: '14px' }}>{award}</li>
//                   ))}
//                 </ul>
//               </div>
//               <div>
